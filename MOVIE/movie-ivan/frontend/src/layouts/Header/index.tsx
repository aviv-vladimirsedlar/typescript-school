    ...
    <header className="bg-white shadow-sm">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="flex items-center">
          <nav>
            <ul className="flex">
              <li className="text-sm font-bold uppercase">
                <Link className="rounded-md p-3 px-4 transition-all duration-500 hover:bg-gray-100" to="/movies">
                  Movie
                </Link>
              </li>
              <li className="text-sm font-bold uppercase">
                <Link className="rounded-md p-3 px-4 transition-all duration-500 hover:bg-gray-100" to="/users">
                  User
                </Link>
              </li>
            </ul>
          ...
          <div className="ml-20 flex items-center text-sm">
            <span>
              Hey <strong>{currentUser?.firstName} </strong>
            </span>
            {renderLogoutButton()}
          </div>
        </div>
