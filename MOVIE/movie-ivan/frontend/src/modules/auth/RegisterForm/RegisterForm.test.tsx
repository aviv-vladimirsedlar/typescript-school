...
describe('RegisterForm', () => {
  ...
  it('should validate required fields and show validation errors', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('first-name-input')).toHaveTextContent('is required');
      expect(screen.getByTestId('last-name-input')).toHaveTextContent('is required');
      expect(screen.getByTestId('email-input')).toHaveTextContent('is required');
      expect(screen.getByTestId('password-input')).toHaveTextContent('is required');
      expect(screen.getByTestId('confirm-password-input')).toHaveTextContent('is required');
    });
  });
});
