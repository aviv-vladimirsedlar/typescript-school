...
-- CreateTable
CREATE TABLE "RoleAllowed" (
    "id" TEXT NOT NULL,
    "action" TEXT NOT NULL,
    "description" TEXT,
    "roleId" TEXT NOT NULL,

    CONSTRAINT "RoleAllowed_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "RoleAllowed" ADD CONSTRAINT "RoleAllowed_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
